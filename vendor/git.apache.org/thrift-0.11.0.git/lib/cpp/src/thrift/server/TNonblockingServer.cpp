...
void TNonblockingServer::TConnection::workSocket() {
  ...
  case SOCKET_RECV_FRAMING:
    ...
    try {
      ...
      if(!strstr(te.what(), "retry")) {
        GlobalOutput.printf("SOCKET_RECV_FRAMING TConnection::workSocket(): %s", te.what());
        close();
  ...
  case SOCKET_RECV:
    ...
    try {
      ...
      //Current approach is parsing exception message, but a better solution needs to be investigated.
      if(!strstr(te.what(), "retry")) {
        GlobalOutput.printf("SOCKET_RECV TConnection::workSocket(): %s", te.what());
        close();
      }
  ...
  case SOCKET_SEND:
    ...
    try {
      ...
      GlobalOutput.printf("SOCKET_SEND TConnection::workSocket(): %s ", te.what());
      close();
      return;
    }
